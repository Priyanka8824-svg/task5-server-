...
SECRET_KEY = 'django-insecure-(iz0-bn1sv3dnkv84e2t7uw7%!3^n$a*q1fs+d%0uwgyiue&6f'
...
LOGGING = {
    ...
    'handlers': {
        'task_app_logs_handler': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': os.path.join(BASE_DIR, 'logs/task_app.log'),
            "formatter": "verbose",
        },
    ...
    'loggers': {
        'task_app.views': {
            'handlers': ['task_app_logs_handler','console'],
            'level': 'DEBUG',
            'propagate': True,
        },
        'account.views': {
...
EMAIL_HOST_PASSWORD = "zbxc iqss ndsw pxxx "
